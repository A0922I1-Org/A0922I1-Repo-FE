...
@Component({
  selector: 'app-manager-purchase-history-sort-by-quantity',
  templateUrl: './manager-purchase-history-sort-by-quantity.component.html',
  styleUrls: ['./manager-purchase-history-sort-by-quantity.component.css']
})
export class ManagerPurchaseHistorySortByQuantityComponent implements OnInit {
